        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RsaKeyUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EncryptedSessionKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SenderEncryptedSessionKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
